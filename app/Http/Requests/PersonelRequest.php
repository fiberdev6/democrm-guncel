<?php
// app/Http/Requests/PersonelRequest.php
...
class PersonelRequest extends FormRequest
{
    ...
    {
        return [
            'name.required' => 'Personel adı zorunludur.',
            'name.min' => 'Personel adı en az :min karakter olmalıdır.',
            'name.max' => 'Personel adı en fazla :max karakter olabilir.',
            ...
            'roles.required' => 'Personel grubu seçiniz.',
            'roles.exists' => 'Geçersiz personel grubu.',
            'password.required' => 'Şifre zorunludur.',
            'password.min' => 'Şifre en az :min karakter olmalıdır.',
            'address.max' => 'Adres en fazla :max karakter olabilir.',
            'status.required' => 'Personel durumu seçiniz.',
    ...
    private function cleanInput($value)
    {
        ...
        if ($this->has('password') && $value === $this->password) {
            return $value;
        }
